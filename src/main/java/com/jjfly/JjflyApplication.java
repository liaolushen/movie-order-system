...
//	}
    ...
    @Bean
	public CommandLineRunner demo(CinemaRepository repository1,
								  MovieToCinemaRepository repository2) {
		return (args) -> {
			// save a couple of customers
			Cinema c = repository1.save(new Cinema(
					"GoGo新天地店",
					"广州大学城新天地二楼"
			));

			repository2.save(new MovieToCinema(
					"2016-05-29",
                    true,
                    1,
                    c.getId()
